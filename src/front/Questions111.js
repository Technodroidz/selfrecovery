                           ...
                           <div className="col-md-10">
                              <div className="row align-items-center">
                                 ...
                                 <div className="col-md-10  question_area">
                                    <input type="text" id="question_1" name='questions[]' className="form-control" placeholder="How much meat do you like on your pizza?"/>
                                 </div>
                              </div>
                           </div>
                        </div>
                                    ...
                                    <div className="row align-items-center">
                                      ...
                                      <label for="answer" className="fs-14">Answer 1:</label>
                                       ...
                                       <div className="col-md-10 answer_area">
                                          <input type="text" id="question_1_answer_1" className="form-control" placeholder="Plenty of Meat"/>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <div className="answer-value-score mb-4">
                              ...
                              <div className="mb-3 row align-items-center" key={index}>
                                 <div className="col-md-8 col-12 mb-2">
                                    ...
                                    <input type="text" name="answervalue" placeholder="Meat" class="form-control mt-2" value={element.answervalue || ""} onChange={e => handleChange(index, e)} />
                                 </div>                                 
                                 <div className="col-md-3 col-9 mb-2">
                                    <label><b className="fs-14">Score:  </b></label>
                                    <select className="form-control mt-2"  name="valueselect" value={element.valueselect || ""} onChange={e => handleChange(index, e)}>
                                 ...
                                 <div className="col-sm text-end">
                                    <div className="answer-value-delete">
                                    <button type="button" onClick={() => removeFormFields(index)}> <i className="fa fa-trash"></i></button> 
                                    </div>
                                 </div>
                                 : null
                                 }
                              ...
                              <div className="add-quizzes-ans-option text-right" onClick={() => addFormFields()}>
